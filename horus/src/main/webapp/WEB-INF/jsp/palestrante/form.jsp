					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="form">
									<form action="/horus/palestrante/save" class="form-validate form-horizontal" id="feedback_form"
										method="post">
									...
									<div class="form-group ">
										...
										<div class="form-group">
											<div class="col-lg-offset-2 col-lg-10">
												...
												<a href="/horus/palestrante/form" class="btn btn-danger" type="button">Cancelar</a>
											</div>
										</div>
									</form>
								</div>
