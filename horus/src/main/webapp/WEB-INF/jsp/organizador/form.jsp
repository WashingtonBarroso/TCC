							...
							<div class="panel-body">
								<div class="form">
									<form class="form-validate form-horizontal" id="feedback_form"
										method="post" action="/appevent/organizador/save">
										...
										<div class="form-group ">
											...
											<div class="col-lg-10">
												...
												<input class="form-control " id="carea" type="hidden"
													name="dto.organizador.tipoOrganizador.id" value="${opcao_selecionada}" />
											</div>
										</div>
										<div class="form-group ">
										...
										<div class="form-group">
											<div class="col-lg-offset-2 col-lg-10">
												...
												<a href="/appevent/organizador/form" class="btn btn-danger"
