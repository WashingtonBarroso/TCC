							...
							<div class="col-lg-12">
								...
								<form id="form" name="form" role="form" novalidate>
									<div class="form-group">
										...
										<div ng-class="{'has-error':form.cargo.$invalid ,'has-success':form.cargo.$valid}">
											<label class="control-label"> Cargo: <span
												class="required"> * </span>
											</label>
											<div class="input-icon right">
												<input class="form-control" placeholder="Digite o cargo do organizador"
													name="cargo" type="text" ng-model="dto.cargo" 
													required maxlength="20">
												<div class="validation-messages help-block" ng-messages="form.cargo.$error">
											        <div ng-message="required"><i class="fa fa-warning"></i> Esse campo é obrigatório!</div>														        
											    </div>
											</div>
										</div>

										<div ng-class="{'has-error':form.area.$invalid ,'has-success':form.area.$valid}">
											<label class="control-label"> Área: <span
												class="required"> * </span>
											</label>
											<div class="input-icon right">
												<input class="form-control" placeholder="Digite a área"
													name="area" type="text" ng-model="dto.area" 
													required maxlength="50">
												<div class="validation-messages help-block" ng-messages="form.area.$error">
											        <div ng-message="required"><i class="fa fa-warning"></i> Esse campo é obrigatório!</div>														        
											    </div>
											</div>
										</div>
										...
										<div>
											...
											<div class="input-icon right">
												<input class="form-control" placeholder="Digite a url"
													name="url" type="text" ng-model="dto.url" 
													maxlength="50">
											</div>
										</div> 
									</div>
