<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<!DOCTYPE html>
<html lang="pt" ng-app="app" ng-controller="NoticiaFormController"
	ng-init='setDTO(${dto});'>
<head>
							...
							<div class="col-lg-12">
								...
								<form id="form" name="form" role="form" novalidate>
									<div class="form-group"
										...
										<label class="control-label"> Mensagem: <span
											class="required"> * </span>
										</label>
										<div class="input-icon right">
											<textarea class="form-control"
												placeholder="Digite a mensagem" name="mensagem" type="text"
												ng-model="dto.mensagem" required maxlength="200"></textarea>
											<div class="validation-messages help-block"
												ng-messages="form.mensagem.$error">
