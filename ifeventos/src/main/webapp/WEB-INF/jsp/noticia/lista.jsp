		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Lista de Notícias </header>

							<table class="table table-striped table-advance table-hover">
								<tbody>
									<tr>
										<th><i class="fa fa-sort-numeric-asc"></i> Nº</th>
										<th><i class=""></i>Notícia</th>
										<th><i class=""></i>Editar</th>
										<th><i class=""></i>Remover</th>
									</tr>
									<c:forEach items="${list}" var="noticia">
										<tr>
											<td>${noticia.id}</td>
											<td>${noticia.mensagem}</td>
											<td>
												<form action="<c:url value="/noticia/load"/>" method="post">
											...
											<td>
												<form action="<c:url value="/noticia"/>" method="post">
													<input name="id" value="${noticia.id}" type="hidden" />
