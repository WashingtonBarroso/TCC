					...
					<div class="col-lg-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div class="form">
									<form action="/ifeventos/noticia/altera" class="form-validate form-horizontal" id="feedback_form" method="post">
									<div class="form-group ">
											<label for="ccomment" class="control-label col-lg-2">Mensagem</label>
											<div class="col-lg-10">
												<input name="noticia.id" type="hidden" value="${noticia.id}" />
