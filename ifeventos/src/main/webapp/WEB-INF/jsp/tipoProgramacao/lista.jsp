		...
		<section id="main-content">
			<section class="wrapper">
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="fa fa-users"></i>Tipo de Programação
						</h3>
						<ol class="breadcrumb">
							<li><i class="fa fa-home"></i><a href="/ifeventos/">Home</a></li>
							<li><i class="fa fa-users"></i>Tipo de Programação</li>
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Lista de Tipos de
								Programação </header>
								...
								<tbody>
									...
									<c:forEach items="${list}" var="tipo">
										<tr>
											...
											<td>
												<div class="btn-group">
													<form action="<c:url value="/tipoProgramacao"/>"
														method="post">
														<input name="id" value="${tipo.id}" type="hidden" />
