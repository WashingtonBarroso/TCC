...
<html lang="pt" ng-app="app"
	ng-controller="TipoProgramacaoListController">
<head>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Tipos de Programação</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
	...
	<!-- Page Controller -->
	<script type="text/javascript"
		src="assets/pages/js/controller/tipo-programacao-list-controller.js"></script>
	<script type="text/javascript"
