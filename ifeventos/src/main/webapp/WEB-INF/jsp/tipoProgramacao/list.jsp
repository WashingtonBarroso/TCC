...
<!DOCTYPE html>
<html lang="pt" ng-app="app" ng-controller="TipoProgramacaoListController">
<head>
...
<body>
                ...
                <!-- 
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           	<h4>Lista de Tipos de Programação</h4>
                        </div>
                 -->
                        <!-- /.panel-heading -->
    ...
    <!-- Page Controller -->
	<script type="text/javascript" src="assets/pages/js/controller/tipo-programacao-list-controller.js"></script>
