...
<html lang="pt" ng-app="app"
	ng-controller="TipoOrganizadorListController">
<head>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Tipos de Organizador</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<table id="table"
									...
									data-toggle="table" data-page-list="[5, 10, 20, 50, 100, 200]">
									<thead>
										<tr>
	...
	<!-- Page Controller -->
	<script type="text/javascript"
		src="assets/pages/js/controller/tipo-organizador-list-controller.js"></script>
	<script type="text/javascript"
