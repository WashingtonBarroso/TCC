...
<!DOCTYPE html>
<html lang="pt" ng-app="app" ng-controller="TipoOrganizadorListController">
<head>
...
<body>
                ...
                <!-- 
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           	<h4>Lista de Tipos de Organizador</h4>
                        </div>
                 -->
                        <!-- /.panel-heading -->
    ...
    <!-- Page Controller -->
	<script type="text/javascript" src="assets/pages/js/controller/tipo-organizador-list-controller.js"></script>
