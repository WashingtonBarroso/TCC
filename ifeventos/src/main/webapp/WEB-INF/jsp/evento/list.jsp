...
<body>
	...
	<div id="wrapper">
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="#"><i class="fa fa-user fa-fw"></i> Meus
								Dados</a></li>
						<li class="divider"></li>
									...
									<table id="table"
										...
										<thead>
											<tr>
												...
												<th data-valign="middle" class="col-xs-1" data-field="id"
												...
												<th data-valign="middle" data-field="endereco.logradouro"
													data-sortable="true">Logradouro</th>
												<th data-valign="middle" data-field="endereco.cidade"
													data-sortable="true">Cidade</th>
												<th data-valign="middle" data-field="endereco.estado"
		...
		<!-- Page Controller -->
		<script type="text/javascript"
			src="assets/pages/js/controller/evento-list-controller.js"></script>
		<script type="text/javascript"
