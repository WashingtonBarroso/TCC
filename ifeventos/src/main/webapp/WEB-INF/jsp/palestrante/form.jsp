							...
							<div class="col-lg-12">
								...
								<form id="form" name="form" role="form" novalidate>
									<div class="form-group">
										...
										<div
											ng-class="{'has-error':form.titulo.$invalid ,'has-success':form.titulo.$valid}">
											<label class="control-label"> Título: <span
												class="required"> * </span>
											</label>
											<div class="input-icon right">
												<input class="form-control" placeholder="Digite o título "
													name="titulo" type="text" ng-model="dto.titulo" required
													maxlength="20">
												<div class="validation-messages help-block"
													ng-messages="form.titulo.$error">
													<div ng-message="required">
														<i class="fa fa-warning"></i> Esse campo é obrigatório!
													</div>
												</div>
										...
										<div
											ng-class="{'has-error':form.resumo.$invalid ,'has-success':form.resumo.$valid}">
											<label class="control-label"> Mini currículo: <span
												class="required"> * </span>
											</label>
											<div class="input-icon right">
												<textarea class="form-control"
													placeholder="Digite o míni curriculo do palestrante"
													name="resumo" ng-model="dto.resumo" required
													maxlength="200"></textarea>
												<div class="validation-messages help-block"
													ng-messages="form.resumo.$error">
													<div ng-message="required">
														<i class="fa fa-warning"></i> Esse campo é obrigatório!
													</div>
												</div>
