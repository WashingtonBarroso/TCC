				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li><a class="" href="/ifeventos/programacao/lista">Consultar</a></li>
							...
							<li class="sub-menu"><a href="javascript:;" class=""> <span>Tipo
								...
								<ul class="sub">
									...
									<li><a class="" href="/ifeventos/tipoProgramacao/lista">Consultar</a></li>
								</ul></li>
							<!-- Fim submenu -->
						</ul></li>
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li><a class="" href="/ifeventos/palestrante/lista">Consultar</a></li>
						</ul></li>
		...
		<section id="main-content">
			...
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading"> Cadastro de Palestrante </header>
							<div class="panel-body">
								<div class="form">
									<form action="/ifeventos/palestrante/save" class="form-validate form-horizontal" id="feedback_form"
										method="post">
									
									 <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Nome <span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="dto.palestrante.nome" value="${dto.palestrante.nome}" minlength="5" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">Título<span class="required"></span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="ctitulo" type="text" name="dto.palestrante.titulo" value="${dto.palestrante.titulo}" required />
                                          </div>
                                      </div>                                   					
									<div class="form-group ">
											<label for="ccomment" class="control-label col-lg-2">Resumo</label>
											<div class="col-lg-10">
												<textarea class="form-control" id="ccomment" name="dto.palestrante.resumo"> ${dto.palestrante.resumo}</textarea>
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-offset-2 col-lg-10">
												<button class="btn btn-success" type="submit">Salvar</button>
												<a href="/ifeventos/palestrante/form" class="btn btn-danger" type="button">Cancelar</a>
											</div>
										</div>
									</form>
								</div>
